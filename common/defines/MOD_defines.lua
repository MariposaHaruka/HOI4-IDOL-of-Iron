...
NDefines.NProduction.BASE_COUNTRY_ENERGY_PRODUCTION = 20.0 			-- The base energy production of a country
NDefines.NProduction.ENERGY_SCALING_COST_BY_FACTORY_COUNT = 0.01 -- Scales energy cost based on the total number of factories
