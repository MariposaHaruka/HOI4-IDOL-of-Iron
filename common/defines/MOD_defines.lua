...
NDefines.NProduction.BASE_FACTORY_SPEED = 5.5 					-- vanilla is 4.0 -- Base factory speed multiplier (how much hoi3 style IC each factory gives).
NDefines.NProduction.BASE_FACTORY_SPEED_MIL = 5.0 				-- vanilla is 3.5 -- Base factory speed multiplier (how much hoi3 style IC each factory gives).
NDefines.NProduction.BASE_FACTORY_SPEED_NAV = 3.5 				-- vanilla is 2.0 -- Base factory speed multiplier (how much hoi3 style IC each factory gives).
NDefines.NProduction.POWERED_FACTORY_SPEED = 6.5					-- vanilla is 5.0 -- Powered factory speed multiplier.
NDefines.NProduction.POWERED_FACTORY_SPEED_MIL = 6.0 			-- vanilla is 4.5 -- Powered factory speed multiplier.
NDefines.NProduction.POWERED_FACTORY_SPEED_NAV = 4.0		    -- vanilla is 2.5 -- Powered factory speed multiplier.
...
NDefines.NProduction.RESOURCE_TO_ENERGY_COEFFICIENT = 18.0		    -- How much energy per coal produces
NDefines.NProduction.BASE_ENERGY_COST = 0.25					    -- How much energy per factory consumes
NDefines.NProduction.ENERGY_COST_CAP = 6.6						    -- Maximum energy cost per factory
...
NDefines.NMilitary.MAX_REGIMENTAL_SUPPORT_HEIGHT = 2		-- Max height of regimental supports in division designer. -- 2개이상은 왜인지 추가 안됨
...
NDefines.NMilitary.REGIMENTAL_SUPPORT_REQUIRED_BATTALIONS = { 2, 4 } -- For each regimental support row, how many battalions are required in the regiment to be able to place a support in that row.
...
-- TENSION DEFINE 재조정
-- 패독 개자식들이 이거 의도적으로 낮춘거 같은데 왜 낮췄는지 모르겠음
NDefines.NDiplomacy.TENSION_STATE_VALUE = 2
...
NDefines.NDiplomacy.TENSION_FORCE_GOVERNMENT = 0.75
